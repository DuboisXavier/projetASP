...
AS
Begin
	Insert into [Utilisateur] ([Nom], [Prenom], [AdresseMail], [Telephone], [MotDePasse], [RoleId], [AdresseId])
	Values (@Nom, @Prenom, @AdresseMail, @Telephone, HASHBYTES('SHA2_512', dbo.GetPreSalt() + @MotDePasse + dbo.GetPostSalt()), @RoleId, @AdresseId);
End
GO
